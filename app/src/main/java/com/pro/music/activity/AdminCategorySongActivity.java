// File: AdminCategorySongActivity.java
...
// Lớp quản lý danh sách bài hát theo danh mục trong phần quản trị
public class AdminCategorySongActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadListSong();   // Tải danh sách bài hát theo danh mục
    }
    ...
    private void loadDataIntent() {
        ...
        if (bundleReceived != null) {
            mCategory = (Category) bundleReceived.get(Constant.KEY_INTENT_CATEGORY_OBJECT); // Lấy đối tượng danh mục
        }
    }
    ...
    private void initToolbar() {
        ...
        binding.toolbar.tvTitle.setText(mCategory.getName()); // Đặt tiêu đề là tên danh mục
    }
    ...
    // Tải danh sách bài hát theo danh mục từ Firebase
    @SuppressLint("NotifyDataSetChanged")
    public void loadListSong() {
        MyApplication.get(this).getSongsDatabaseReference()
                .orderByChild("categoryId").equalTo(mCategory.getId()) // Lọc bài hát theo categoryId
